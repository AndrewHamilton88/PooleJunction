...
namespace ParamincsSNMPcontrol
{
    ...
    class ParaESVstarter : ParaStarter
    {
            ...
            : base(MP)
        {
            ...
            ControlCommand = "C:\\\"Program Files\"\\\"Paramics 2000\"\\paramics2010.0\\bin\\ParaEsv.exe -network \"";
        }
    ...
    class ParaBSMstarter : ParaStarter
    {
            ...
            : base(MP)
        {
            ...
            ControlCommand = "C:\\\"Program Files\"\\\"Paramics 2000\"\\paramics2010.0\\bin\\ParaBSM.exe -paused -network \"";
        }
