...
namespace ParamicsPuppetMaster
{
    ...
    public class ParamicsDBi
    {
        ...
        public ParamicsDBi(string Database, string Source, string user, string password)
        {
            ...
            BuildVidTab += " (ViD VARCHAR(5), VehicleType INT, BornTime TIME, BornLink VARCHAR(7), RouteName VARCHAR(15), Origin INT, Destination INT, ParamicsTag INT, BornStage INT, BornScenario INT, NextLink VARCHAR(15), NextNextLink VARCHAR(15), Obsolete BOOL, MagicNumbers VARCHAR(13), Misc1 VARCHAR(15), Misc2 VARCHAR(15), PRIMARY KEY (ViD)); ";

            string BuildVposTab = ("CREATE TABLE IF NOT EXISTS " + VposTab);
            BuildVposTab += " (ViD VARCHAR(5), AtTime TIME, OnLink VARCHAR(7), AlongLink DOUBLE, Speed DOUBLE, Xpos DOUBLE, Ypos DOUBLE, Zpos DOUBLE, InStage INT, InScenario INT, NextLink VARCHAR(15), NextNextLink VARCHAR(15), Obsolete BOOL, Misc1 VARCHAR(15), Misc2 VARCHAR(15), FOREIGN KEY (ViD) REFERENCES " + ViDTab + "(ViD), PRIMARY KEY (ViD,AtTime,InStage,InScenario)); ";
